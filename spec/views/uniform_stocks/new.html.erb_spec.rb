...
describe "uniform_stocks/new" do
  before(:each) do
    assign(:uniform_stock, stub_model(UniformStock,
      :uniform_id => 1,
      :size => "9.99",
      :category => "MyString",
      :max_quantity => 1,
  ...
  it "renders new uniform_stock form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", uniform_stocks_path, "post" do
